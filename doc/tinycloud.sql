...
CREATE TABLE `t_uc_login_log`  (
  ...
  `session_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '本次登录的session_id或者token，登陆失败的话则不插入',
  ...
  `login_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '登录ip物理地址',
