package org.liuxingyu.tinycloud.common.utils.bean;
...
/**
 * <p>
 *  bean工具类，使用Spring BeanUtils封装实现,
 *  应该避免用 Apache Beanutils 进行属性的 copy。因为Apache BeanUtils 性能较差，
 *  可以使用其他方案比如 Spring BeanUtils, Cglib BeanCopier，注意均是浅拷贝。
 * </p>
 *
 * @author liuxingyu01
 * @since 2023/3/10 14:49
 **/
