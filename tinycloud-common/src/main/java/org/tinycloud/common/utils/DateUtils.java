...
public class DateUtils {
    private final static String MILLI_FORMAT = "yyyyMMddHHmmssSSS";
    ...
    public static String plusMonth(int count) {
        LocalDate today = LocalDate.now();
        LocalDate nextMonth = today.plus(count, ChronoUnit.MONTHS); // 使用变量赋值
        DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern(DATE_FORMAT);
        return dateTimeFormatter.format(nextMonth);
    }
